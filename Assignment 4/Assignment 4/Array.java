 ...
 * </pre>
 *
 * Arrays have a fixed length that determines the valid index range. Arrays hold
 * values of arbitrary type; get() reads the value at a given index, put()
 * writes the value at a given index.
 *
 * @param <T>
 *            Element type.
 */

 ...
 *
 * All operations except push() take O(1) time in the worst case; push() takes
 * O(1) amortized time because the array may need to be resized; however,
 * compared to ListStack, fewer push() operations result in objects being
 * allocated.
 *
 * @param <T>
 *            Element type.

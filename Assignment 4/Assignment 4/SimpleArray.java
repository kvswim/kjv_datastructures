 ...
 * style of code we're about to write a lot of. Second it's useful because
 * Java's generics don't really play well with Java's basic arrays; we'll use
 * SimpleArray in lots of places where Java's arrays would give us generic
 * grief.
 *
 * @param <T>
 *            Element type.
...
public class SimpleArray<T> implements Array<T> {
     ...
     *
     * @param n
     *            Length of array, must be n &gt; 0.
     * @param t
     *            Default value to store in each slot.

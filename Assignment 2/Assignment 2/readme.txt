...
Decisions: Integer given in put() is a representation of the index in the array, not necessarily
related to upper and lower bounds. I prefer regular arrays for ease of use.
